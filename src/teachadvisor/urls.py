...
from home.views import HomeView, AboutUsView, PromotionView, ContactView, TermsAndConditionView, DisclaimerView, PrivacyPolicyView, RefundPolicyView, FAQTutorView, FAQStudentView, CSupportView, TutorialsView, CareersView, PressView, PartnershipsView, Test
